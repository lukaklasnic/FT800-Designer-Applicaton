...
def showDialProperties( main_window, current_index) :
    ...
    main_window.diameter_spin_dial.valueChanged.connect( lambda value: updateDialSize( main_window, value ) )
...
def showLabelProperties( main_window, current_index ):
    ...
    main_window.pos_x_spin_label.setValue( getattr(main_window.current_shape, 'position_x', main_window.current_shape.x()) )
    ...
    main_window.pos_y_spin_label.setValue( getattr(main_window.current_shape, 'position_y', main_window.current_shape.y()) )
