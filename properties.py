...
def showScrollBarProperties( main_window, current_index ):
    ...
    main_window.knob_size_spin_scrollbar.setRange( 10, 100 )
    main_window.knob_size_spin_scrollbar.setValue( main_window.current_shape.knob_size )
    main_window.knob_size_spin_scrollbar.valueChanged.connect( lambda value: updateScrollbarKnobSize( main_window, value ) )
...
def showSliderProperties( main_window, current_index ):
    ...
    main_window.knob_color_rect_slider.mousePressEvent = lambda e: changeSliderKnobColor( main_window )
