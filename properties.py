...
def showCanvasProperties( main_window, canvas, start_index=0 ):
    ...
    active_checkbox.stateChanged.connect( lambda state: changeCanvasActive( main_window, canvas, state ) )
    ...
    visible_checkbox.stateChanged.connect( lambda state: changeCanvasVisible( main_window, canvas, state ) )
    ...
    static_checkbox.stateChanged.connect( lambda state: changeCanvasStatic( main_window, canvas, state ) )
    ...
    name_edit.textChanged.connect( lambda text: changeCanvasName( main_window, canvas, text ) )
    ...
    canvas_color_rect.mousePressEvent = lambda e: changeCanvasColor( main_window, canvas, canvas_color_rect )
    ...
    grid_checkbox.stateChanged.connect( lambda state: toggleGrid( main_window, canvas, state ) )
    ...
    grid_color_rect.mousePressEvent = lambda e: changeGridColor( main_window, canvas, grid_color_rect )
    ...
    grid_type_combobox.currentTextChanged.connect( lambda text: changeGridType( main_window, canvas, text ) )
    ...
    grid_size_spinbox.valueChanged.connect( lambda value: changeGridSize( main_window, canvas, value ) )
...
def showProgressBarProperties( main_window, current_index ):
    ...
    main_window.progress_pos_x_spin.setStyleSheet( "color: lightsalmon; background-color: #383838;" )
    main_window.progress_pos_x_spin.setFixedWidth( 70 )
    ...
    main_window.progress_pos_y_spin.setStyleSheet( "color: lightsalmon; background-color: #383838;" )
    main_window.progress_pos_y_spin.setFixedWidth( 70 )
    ...
    main_window.progress_width_spin.setStyleSheet( "color: lightsalmon; background-color: #383838;" )
    main_window.progress_width_spin.setFixedWidth( 70 )
    ...
    main_window.progress_height_spin.setStyleSheet( "color: lightsalmon; background-color: #383838;" )
    main_window.progress_height_spin.setFixedWidth( 70 )
    ...
    main_window.progress_max_spin.setStyleSheet( "color: lightsalmon; background-color: #383838;" )
    ...
    main_window.progress_value_spin.setStyleSheet( "color: lightsalmon; background-color: #383838;" )
