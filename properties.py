...
def showButtonProperties( main_window, current_index ):
    ...
    threed_label.setStyleSheet( "color: lightsalmon; font-size: 14px;" )
...
def showKeysProperties( main_window, current_index ):
    ...
    _3d_label = QLabel( "3D:" )
    _3d_label.setStyleSheet( "color: lightsalmon; font-size: 14px;" )
...
def showClockProperties( main_window, current_index ):
    ...
    use_3d_label.setStyleSheet( "color: lightsalmon; font-size: 14px;" )
...
def showDialProperties( main_window, current_index) :
    ...
    main_window._3d_checkbox_dial.stateChanged.connect( lambda state: updateDial3d( main_window, state ) )
...
def showScrollBarProperties( main_window, current_index ):
    ...
    main_window._3d_checkbox_scrollbar.stateChanged.connect( lambda state: updateScrollbar3d( main_window, state ) )
...
def showSliderProperties( main_window, current_index ):
    ...
    main_window._3d_checkbox_slider.stateChanged.connect( lambda state: updateSlider3d( main_window, state ) )
