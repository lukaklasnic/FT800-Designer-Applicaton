...
def showButtonProperties( main_window, current_index ):
    ...
    main_window.pos_x_spin.setStyleSheet( "color: lightsalmon; background-color: #383838;" )
    main_window.pos_x_spin.setFixedWidth( 70 )
    ...
    main_window.pos_y_spin.setStyleSheet( "color: lightsalmon; background-color: #383838;" )
    main_window.pos_y_spin.setFixedWidth( 70 )
    ...
    main_window.width_spin.setStyleSheet( "color: lightsalmon; background-color: #383838;" )
    main_window.width_spin.setFixedWidth( 70 )
    ...
    main_window.height_spin.setStyleSheet( "color: lightsalmon; background-color: #383838;" )
    main_window.height_spin.setFixedWidth( 70 )
...
def showDialProperties( main_window, current_index) :
    ...
    main_window.diameter_spin_dial.valueChanged.connect( lambda value: updateDialDiameter( main_window, value ) )
    ...
    main_window.effect_3d_checkbox_dial.setChecked( getattr( main_window.current_shape, '_3d', True ) )
...
def showToggleProperties( main_window, current_index ):
    ...
    main_window.thumb_color_rect_toggle.mousePressEvent = lambda e: changeToggleThumbColor( main_window )
    ...
    main_window.effect_3d_checkbox_toggle.setChecked( main_window.current_shape._3d )
    main_window.effect_3d_checkbox_toggle.stateChanged.connect( lambda state: updateToggle3D( main_window, state ) )
    effect_3d_layout.addWidget( main_window._3d_checkbox_toggle )
    effect_3d_widget = QWidget()
    effect_3d_widget.setLayout( effect_3d_layout )
    main_window.properties_layout.insertWidget( current_index, effect_3d_widget )
    current_index += 1
...
def showScrollBarProperties( main_window, current_index ):
    ...
    main_window.thumb_color_rect_scrollbar.mousePressEvent = lambda e: changeScrollbarThumbColor( main_window )
    ...
    track_color_label = QLabel( "Background color:" )
    track_color_label.setStyleSheet( "color: lightsalmon; font-size: 14px;" )
    ...
    main_window.track_color_rect_scrollbar.mousePressEvent = lambda e: changeScrollbarTrackColor( main_window )
    ...
    main_window.effect_3d_checkbox_scrollbar.setChecked( getattr( main_window.current_shape, '_3d', True ) )
...
def showSliderProperties( main_window, current_index ):
    ...
    main_window.effect_3d_checkbox_slider.setChecked( getattr( main_window.current_shape, '_3d', False ) )
...
def showProgressBarProperties( main_window, current_index ):
    ...
    effect_3d_layout.addStretch( 1 )
    main_window.effect_3d_checkbox = QCheckBox()
    main_window.effect_3d_checkbox.setChecked( main_window.current_shape._3d )
